...
1.	[Отправка изменений в апстрим](#отправка-изменений-в-апстрим)
1.	[Выводы](#выводы)
...
Ниже приведён процесс синхронизации локального репозитория с удалённым на
GitHub (upstream).

[![asciicast](assets/asciinemas/pushing.gif)](https://asciinema.org/a/xfMJ7HXeBI4mKjlreTH4lfJ5x)

На этом работа завершена &mdash; все задачи сделаны, а дальнейшие коммиты
лишь направлены на исправление опечаток и мелкие улучшения.

#	Выводы

Итого, была завершена очередная работа по основам программирования.
Она предполагает изучение Git, GitHub и уверенное ими пользование &mdash;
всё это у меня уже было сполна до этой работы, поэтому работа была
аналогична моему среднестатистическому рабочему дню.

Зато писать отчёт на Markdown было весело: наконец, появилась возможность не только
вставлять код текстом, но и записывать терминальные сессии и встраивать их
для прекрасного вида.
